...
export const WeeksGrid = forwardRef<HTMLInputElement, WeeksGridProps>(({
  ...
  <div
    ref={ref}
    className="mt-0 md:mt-1.5 w-fit h-full grid grid-cols-[repeat(52,6px)] grid-rows-[repeat(90,5px)] md:grid-rows-[repeat(90,6px)] gap-[1px] md:gap-1 content-center justify-center overflow-y-scroll"
  >
